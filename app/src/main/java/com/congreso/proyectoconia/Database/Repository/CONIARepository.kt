package com.congreso.proyectoconia.Database.Repository

import androidx.annotation.WorkerThread
import androidx.lifecycle.LiveData
import com.congreso.proyectoconia.Database.Dao.*
import com.congreso.proyectoconia.Database.Entities.*
import com.congreso.proyectoconia.Database.ModelsRetrofit.*
import com.congreso.proyectoconia.Database.Retrofit.retroFitServices
...
class CONIARepository(
    ...
    fun deleteAnotacionApi(id : String) : Call<anotacion>{
        return retroFitServices.getRetrofit().deleteAnotacion(id)
    }
    ...
    fun getAllProgramacion2() : LiveData<List<programacion>> = Programacion.getAllProgramacion2()

    fun getOneProgramacion2(id: String) : LiveData<programacion> = Programacion.getOneProgramacion2(id)
