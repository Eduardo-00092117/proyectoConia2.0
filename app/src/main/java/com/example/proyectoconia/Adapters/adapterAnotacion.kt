...
class adapterAnotacion(var anotacion : List<anotacion>, var clickListener:(anotacion)->Unit ) : RecyclerView.Adapter<adapterAnotacion.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)= holder.onBind(anotacion[position],clickListener)
